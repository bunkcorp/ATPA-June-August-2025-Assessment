...
The following visualizations were generated from the data preparation script and provide key insights into the arrest patterns:

**Visualization 1: Multiple Arrests Distribution**
- **Finding**: 94.6% of incidents result in single arrests, while 5.4% result in multiple arrests
- **Interpretation**: Most criminal incidents involve single perpetrators
- **Business Implication**: Law enforcement can generally expect single arrests per incident

**Visualization 2: Multiple Arrests Rate by Crime Category**
- **Finding**: Family offenses, liquor law violations, and trespassing have the highest multiple arrest rates
- **Interpretation**: Certain crime types are more likely to involve multiple perpetrators
- **Business Implication**: Resource allocation should consider crime type when planning for multiple arrests

**Visualization 3: Multiple Arrests Rate by Crime Against**
- **Finding**: Society crimes (8.3%) and Property crimes (7.5%) have higher multiple arrest rates than Person crimes (3.0%)
- **Interpretation**: Crimes against society and property are more likely to involve multiple perpetrators
- **Business Implication**: Different response strategies may be needed based on crime target

**Visualization 4: Multiple Arrests Rate by Weapon Type**
- **Finding**: Certain weapon types are associated with higher multiple arrest rates
- **Interpretation**: Weapon presence may indicate more serious incidents involving multiple perpetrators
- **Business Implication**: Weapon information can help predict the likelihood of multiple arrests
...
### **Arrest Pattern Analysis Results**

**Dataset Characteristics:**
- **Total Arrestee Records**: 28,682
- **Unique Incidents**: 26,955
- **Average Arrests per Incident**: 1.06
- **Multiple Arrests Rate**: 5.4%

**Key Insights from Analysis:**
1. **Single vs Multiple Arrests**: 94.6% of incidents result in single arrests, indicating most crimes involve individual perpetrators
2. **Crime Category Patterns**: Family offenses (35.0%), liquor law violations (31.3%), and trespassing (28.1%) have the highest multiple arrest rates
3. **Crime Target Analysis**: Society crimes (8.3%) and property crimes (7.5%) show higher multiple arrest rates than person crimes (3.0%)
4. **Data Completeness**: The dataset contains only incidents that resulted in arrests, limiting the ability to predict arrest likelihood for all incidents

**Missing Value Analysis:**
- **under_18_disposition_code**: 93.95% missing (not applicable to most cases)
- **hc_code**: 41.55% missing (hate crime classification)
- **resident_code**: 12.98% missing (residency status)
